...
public class Answer_2_Activity extends AppCompatActivity implements OnClickHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numberOfPage.setText("2 of 7");
    }

    @Override
    public void onClickNextButton(View v) {
        RadioButton radioButton = (RadioButton) findViewById(R.id.klimt);
        if (radioButton.isChecked()){
            MainActivity.score += 2;
        }

        Intent intent = new Intent(this, Answer_3_Activity.class);
    ...
    public void onClickHintButton(View v) {
        ...
        builder.setMessage(R.string.hint_2);
